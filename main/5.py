...
with open('/Users/zeinaddinzurgambayev/Desktop/parser/three/letter_combinations.txt', 'r') as file:
...
with open('/Users/zeinaddinzurgambayev/Desktop/parser/brand_map.json', 'r') as json_file:
...
# Функция для обновления нового JSON-файла
def update_json_file():
    with open('brand_map_updated.json', 'w') as outfile:
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            with lock:
                ...
                if new_entries:
                    print(brand)
                    update_json_file()  # Обновление нового JSON-файла, если были добавлены новые записи
        else:
...
# Function to remove duplicates from the final JSON file (just in case)
def remove_duplicates():
    unique_brands = {}
    for key, value in brand_map.items():
        if key not in unique_brands:
            unique_brands[key] = value
...
if __name__ == "__main__":
    ...
    # Remove duplicates before final save
    brand_map = remove_duplicates()

    # Запись данных в новый JSON файл
    update_json_file()

    print("Данные успешно сохранены в файл brand_map_updated.json")
