...
with open("/Users/zeinaddinzurgambayev/Desktop/parser/nurbek/entries4.json", "r", encoding="utf-8") as json_file:
...
def send_request(session, headers, params, proxy=None):
    try:
        ...
        if response.status_code == 200:
            ...
            with open("count_brand_entries_four.json", "w", encoding="utf-8") as json_file:
                json.dump(brand_entries_count, json_file, ensure_ascii=False, indent=4)
            print(f"Brand with id {params['brand_ids']} seved to count_brand_entries_four.json")
...
def send_requests_concurrently(total_requests, max_workers=10):
    ...
    print("Brand product counts have been saved to count_brand_entries_four.json")
